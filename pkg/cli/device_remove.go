...
// ActionDeviceRemove object.
type ActionDeviceRemove struct {
...
// NewActionDeviceRemove constructor.
func NewActionDeviceRemove(log logger) *ActionDeviceRemove {
...
func (a *ActionDeviceRemove) Usage() {
	a.flagset.Usage()
}

// Execute action.
func (a *ActionDeviceRemove) Execute(args []string) error {
	logPrefix := "[device-remove] Execute"
	...
	b := manager.DeviceRemoveRequest{
		IP: *a.ip,
	}.Marshal()
	b = rpcapi.Request{
		Method: "manager/device/remove",
		Params: b,
	}.Marshal()
...
func (a *ActionDeviceRemove) validate() error {
