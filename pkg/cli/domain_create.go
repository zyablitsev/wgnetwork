...
// ActionDomainCreate object.
type ActionDomainCreate struct {
...
// NewActionDomainCreate constructor.
func NewActionDomainCreate(log logger) *ActionDomainCreate {
...
func (a *ActionDomainCreate) Usage() {
	a.flagset.Usage()
}

// Execute action.
func (a *ActionDomainCreate) Execute(args []string) error {
	logPrefix := "[domain-create] Execute"
	...
	b = rpcapi.Request{
		Method: "manager/dns/domain/create",
		Params: b,
	}.Marshal()
...
func (a *ActionDomainCreate) validate() error {
