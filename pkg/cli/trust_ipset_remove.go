...
// ActionTrustIPSetRemove object.
type ActionTrustIPSetRemove struct {
...
// NewActionTrustIPSetRemove constructor.
func NewActionTrustIPSetRemove(log logger) *ActionTrustIPSetRemove {
...
func (a *ActionTrustIPSetRemove) Usage() {
	a.flagset.Usage()
}

// Execute action.
func (a *ActionTrustIPSetRemove) Execute(args []string) error {
	logPrefix := "[trust-ipset-remove] Execute"
	...
	b = rpcapi.Request{
		Method: "manager/trust/ipset/remove",
		Params: b,
	}.Marshal()
...
func (a *ActionTrustIPSetRemove) validate() error {
